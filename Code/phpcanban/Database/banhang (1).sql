...
--
-- Host: 127.0.0.1
-- Generation Time: May 03, 2021 at 04:05 PM
...
INSERT INTO `nn_admin` (`MaUser`, `Ten`, `NgaySinh`, `SDT`, `Email`, `TaiKhoan`, `MatKhau`, `RandomKey`, `DiaChi`, `TinhThanh`, `QuanHuyen`, `GioiTinh`) VALUES
('f44ed4d5-a42c-11eb-a957-00067b1324c7', 'Nguyen Van DO', '2021-04-23', '12312312312', 'namdong92@gmail.com', 'namdong92@gmail.com', '123456', '123456', '', '', '', 0);
...
--
-- Dumping data for table `nn_admin_nhom`
--

INSERT INTO `nn_admin_nhom` (`Ma`, `Ten`, `MoTa`, `CapCha`) VALUES
('Admin', 'Quản Trị Viên', 'Quản Trị Viên', 0),
('NhanVien', 'NhanVien', 'Nhan Viên', 0),
('QuanLy', 'Quản Lý', 'Quản Lý', 0);
...
--
-- Dumping data for table `nn_admin_quyen`
--

INSERT INTO `nn_admin_quyen` (`MaUser`, `MaNhom`) VALUES
('f44ed4d5-a42c-11eb-a957-00067b1324c7', 'Admin'),
('f44ed4d5-a42c-11eb-a957-00067b1324c7', 'NhanVien');
...
(5, 'Code', 'TenHH', 'TenKhongDau', '0.00', 0, 1, 1, 'NguonGoc', 'QuyCachDongGoi', 'MoTaNgan', 'BaiViet', 'ThongSoKyThuat', 0, 0, 0, '0.00', 0, 0, '2021-01-01 00:00:00', '2021-01-01 00:00:00', '2021-01-01 00:00:00', 0, 'Images', 'vi');
...
(1, 'Ao Thun', 'ao-thun', 1, NULL, NULL, 'vi', 0),
(2, 'Ao Khoac 1', 'ao-khoac-1', 0, 1, '{}', 'vi', 0),
(3, 'Ao Khoac', 'ao-khoac', 0, 1, '{}', 'vi', 0),
(4, 'Ao Khoac', 'ao-khoac', 0, 1, '{}', 'vi', 0);
...
--
-- Dumping data for table `nn_menu`
--

INSERT INTO `nn_menu` (`Ma`, `Ten`, `Link`, `HinhAnh`, `STT`, `HienThi`, `ViTri`, `Nhom`, `CapCha`, `GhiChu`) VALUES
(27, 'Trang Chủ', '#', '', 0, 0, '', 'MainMenu', 0, ''),
(28, 'asd asdas', 'asda', '/public/menu/018019900_1619616772Home_one_05_-_Chu_DinhCopy.gif', 0, 0, '', 'asdas', 0, ''),
(29, 'Trang Chủ', 'asdasdas', '/public/menu/042410800_1619616821Home_one_02_-_Copy.gif', 0, 0, '', 'asdasdas', 0, ''),
(30, 'Trang Chủ', '#', '', 0, 0, '', 'asdas', 0, ''),
(31, 'Trang Chủ', '#', '', 0, 0, '', 'asdas', 0, ''),
(32, 'aaaaaaaaaaaaa', 'aaaaaaaaaaaa', '', 0, 0, '', 'aaaaaaaaaaa', 0, '');
